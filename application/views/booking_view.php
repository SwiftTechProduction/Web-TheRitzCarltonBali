            ...
            <div id="wrapper" >
                ...
                <div>
                    ...
                    <div class="container" >
                        <h3>Booking Data</h3>
                        <br />
                        <button class="btn btn-success" onclick="add_booking()"><i class="glyphicon glyphicon-plus"></i> Booking</button>
                    ...
                    <script type="text/javascript">
                            ...
                            function edit_booking(id)
                            {
                                ...
                                $.ajax({
                                    url: "<?php echo site_url('booking/ajax_edit/') ?>/" + id,
                                    type: "GET",
                                    dataType: "JSON",
                            ...
                            function save()
                            {
                                ...
                                if (save_method == 'add')
                                {
                                    url = "<?php echo site_url('booking/ajax_add') ?>";
                                } else
                                {
                                    url = "<?php echo site_url('booking/ajax_update') ?>";
                                }
                            ...
                            function delete_booking(id)
                            {
                                if (confirm('Are you sure delete this data?'))
                                {
                                    ...
                                    $.ajax({
                                        url: "<?php echo site_url('booking/ajax_delete') ?>/" + id,
                                        type: "POST",
                                        dataType: "JSON",
                                        success: function (data)
                                        {
                                    ...
                                    <form action="#" id="form" class="form-horizontal">
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea name="kode_pelanggan" placeholder="Kode Pelanggan" class="form-control"></textarea>
                                                    <span class="help-block"></span>
                                                </div>
                                            </div>
